$(document).ready(function () {
    ...
    $('#searchButton').click(function(){
      ...
      resetAll();
        ...
        if(choice == "showAll"){
        var tempurl='http://localhost:8080/dvds';
        }
        else if(choice == "searchTitle" && term != null){
          var tempurl='http://localhost:8080/dvds/title/' + term;
        }
        else if(choice == "searchYear" && term != null && term.length == 4 && isNaN(term) == false){
          var tempurl='http://localhost:8080/dvds/year/' + term;
        }
        else if(choice == "searchDirector" && term != null){
        var tempurl='http://localhost:8080/dvds/director/' + term;
        }
        else if(choice == "searchRating" && term != null){
        var tempurl='http://localhost:8080/dvds/rating/' + term;
        }
        else{
        //  error: function() {
